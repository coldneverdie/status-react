...
jstring Java_im_status_NimStatus_exportUnencryptedDatabase(JNIEnv* env, jobject thiz,
                                                        jstring jaccountData,
                                                        jstring jpassword,
                                                        jstring jpath) {
  ...
  const char * result = exportUnencryptedDatabase(accountData, password, path);
...
jstring Java_im_status_NimStatus_importUnencryptedDatabase(JNIEnv* env, jobject thiz,
                                                        jstring jaccountData,
                                                        jstring jpassword,
                                                        jstring jpath) {
  const char * accountData = (*env)->GetStringUTFChars(env, jaccountData, 0);
  ...
  const char * result = importUnencryptedDatabase(accountData, password, path);
